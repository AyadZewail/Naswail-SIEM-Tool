...
class AnalysisController(threading.Thread, QObject):
    ...
    def __init__(
        ...
        self.figure = figure
        self.canvas = canvas
        self.qued_packets = queuedPacekts
        self.sensor_system = sensorSys
        self.list_of_nodes = []
        ...
        self.ui.refreshMapButton.clicked.connect(self.refresh_geomap)
    ...
    def find_unique_devices_and_edges(self):
        try:
            ...
            for packet in self.qued_packets:
                ...
                islocal=self.is_local_ip(dst_ip)
                islocal2=self.is_local_ip(src_ip)
    ...
    def display_histogram(self):
        try:
            ...
            if self.ui.comboBox_3.currentText()=="inside/outside":
                total_inside=self.total_inside_packets
                total_outside=self.total_outside_packets
    ...
    def display_graph(self):
        ...
        if self.ui.comboBox_4.currentText()=="inside/outside":
            total_inisde=self.total_inside_packets
            total_outside=self.total_outside_packets
            labels=["Inside","Outside"]
            counts=[]
        ...
        if self.ui.comboBox_4.currentText() == "Bandwidith":
            ...
            bandwidith = self.bandwidth_data
            if not bandwidith:
    ...
    def display_heatmap(self):
            try:
                ...
                if self.ui.comboBox_5.currentText() == "Protocols":
                    ...
                    packet_stats = self.packets  # Replace with your actual packet stats
    ...
    def get_location(self, ip):
        try:
            ...
            return self.real_lat, self.real_lon  # Use real location as fallback
    ...
    def update_location_label(self):
        ...
        if self.real_location_name:
            self.ui.locationLabel.setText(f"Network Traffic Map (Real Location: {self.real_location_name})")
        else:
            self.ui.locationLabel.setText("Network Traffic Map (Location: Unknown)")
