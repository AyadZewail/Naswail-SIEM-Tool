...
class Ui_Naswail_Analysis(object):
    def setupUi(self, Naswail_Analysis):
        Naswail_Analysis.setObjectName("Naswail_Analysis")
        Naswail_Analysis.resize(1575, 3555)
        Naswail_Analysis.setMinimumSize(QtCore.QSize(1000, 1000))
        Naswail_Analysis.setStyleSheet("QWidget:window {                    /* Borders around the code editor and debug window */\n"
...
"}")
        self.horizontalLayoutWidget = QtWidgets.QWidget(parent=Naswail_Analysis)
        ...
        self.label_4 = QtWidgets.QLabel(parent=Naswail_Analysis)
        ...
        self.graphicsView = QtWidgets.QGraphicsView(parent=Naswail_Analysis)
        self.graphicsView.setGeometry(QtCore.QRect(10, 20, 71, 61))
        self.graphicsView.setObjectName("graphicsView")
        self.graphicsView_2 = QtWidgets.QGraphicsView(parent=Naswail_Analysis)
        self.graphicsView_2.setGeometry(QtCore.QRect(10, 10, 81, 51))
        self.graphicsView_2.setObjectName("graphicsView_2")
        self.scrollArea = QtWidgets.QScrollArea(parent=Naswail_Analysis)
...
"")
        ...
        self.retranslateUi(Naswail_Analysis)
        QtCore.QMetaObject.connectSlotsByName(Naswail_Analysis)

    def retranslateUi(self, Naswail_Analysis):
        _translate = QtCore.QCoreApplication.translate
        Naswail_Analysis.setWindowTitle(_translate("Naswail_Analysis", "Form"))
        self.pushButton_4.setText(_translate("Naswail_Analysis", "Home"))
        self.pushButton_3.setText(_translate("Naswail_Analysis", "Tools"))
        self.pushButton_2.setText(_translate("Naswail_Analysis", "Analysis"))
        self.label_4.setText(_translate("Naswail_Analysis", "Naswail"))
        self.pushButton_9.setText(_translate("Naswail_Analysis", "PushButton"))
        self.label_9.setText(_translate("Naswail_Analysis", "                                                    time series"))
        self.label_13.setText(_translate("Naswail_Analysis", "filter on:"))
        self.label_8.setText(_translate("Naswail_Analysis", "filter on"))
        self.comboBox_6.setItemText(0, _translate("Naswail_Analysis", "Protocols"))
        self.comboBox_6.setItemText(1, _translate("Naswail_Analysis", "Sensors"))
        self.comboBox_6.setItemText(2, _translate("Naswail_Analysis", "Bandwidth"))
        self.comboBox_2.setItemText(0, _translate("Naswail_Analysis", "Protocols"))
        self.comboBox_2.setItemText(1, _translate("Naswail_Analysis", "Sensors"))
        self.comboBox_2.setItemText(2, _translate("Naswail_Analysis", "inside/outside"))
        self.comboBox_4.setItemText(0, _translate("Naswail_Analysis", "Protocols"))
        self.comboBox_4.setItemText(1, _translate("Naswail_Analysis", "inside/outside"))
        self.comboBox_4.setItemText(2, _translate("Naswail_Analysis", "Sensors"))
        self.comboBox_4.setItemText(3, _translate("Naswail_Analysis", "Bandwidth"))
        self.pushButton_7.setText(_translate("Naswail_Analysis", "PushButton"))
        self.comboBox_5.setItemText(0, _translate("Naswail_Analysis", "Protocols"))
        self.comboBox_5.setItemText(1, _translate("Naswail_Analysis", "Sensors"))
        self.comboBox_5.setItemText(2, _translate("Naswail_Analysis", "Bandwidth"))
        self.label_2.setText(_translate("Naswail_Analysis", "                                                                                 Pie Chart"))
        self.label_5.setText(_translate("Naswail_Analysis", "filter on:"))
        self.pushButton_8.setText(_translate("Naswail_Analysis", "PushButton"))
        self.label_14.setText(_translate("Naswail_Analysis", "filter on:"))
        self.label_10.setText(_translate("Naswail_Analysis", "                                                          Heatmap"))
        self.label_7.setText(_translate("Naswail_Analysis", "                                                             Graph"))
        self.pushButton_5.setText(_translate("Naswail_Analysis", "PushButton"))
        self.label_3.setText(_translate("Naswail_Analysis", "                                                          Hstogram"))
        self.comboBox_3.setItemText(0, _translate("Naswail_Analysis", "Protocols"))
        self.comboBox_3.setItemText(1, _translate("Naswail_Analysis", "inside/outside"))
        self.comboBox_3.setItemText(2, _translate("Naswail_Analysis", "Sensors"))
        self.label_6.setText(_translate("Naswail_Analysis", "filter on:"))
        self.pushButton_6.setText(_translate("Naswail_Analysis", "PushButton"))
